...
RUN echo -e "Username: hacker\nPassword: EscalateMe." > /home/someuser/hint.txt
...
RUN echo "<html><head><title>Vulnerable Server</title></head><body><h1>Look Deeper!</h1><p>The real secrets are hidden from plain sight...</p><div style=\"display:none;\" id=\"hiddenCredentials\">  <span id=\"username\">Username: someuser</span><br>  <span id=\"password\">Password: Welcome123</span></div></body></html>" > /var/www/html/index.html
...
# Copy website into Apache directory
COPY index.html /var/www/html/index.html

COPY vuln-reports.html /var/www/html/vuln-reports.html
COPY vuln-login.html /var/www/html/vuln-login.html
